...
!(function (e, t) {
        ...
        r =
                            ...
                            if ('loading' === document.readyState || 'interactive' === document.readyState) document.addEventListener('readystatechange', checkWarn);
                                ...
                                t &&
                                    ...
                                    (console.log(
                                        ...
                                        w(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)
                                    ),
                                    console.log(
                    ...
                    setTimeout(function () {
                        t &&
                            (window.location.href =
                                ...
                                a +
                                w(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) +
                                '?plugin=' +
                                i +
                                '&source=trial');
                    }, 4e3);
            ...
            (ScrollSmoother.register = function register(e) {
                return (
                    L ||
                        ((F = e || t()),
                        s() && window.document && ((I = window), (j = document), (U = j.documentElement), (q = j.body)),
                        F &&
                            ((D = F.utils.toArray),
                            (V = F.utils.clamp),
                            (Y = F.parseEase('expo')),
    ...
    function ScrollSmoother(t) {
        ...
        function Wa(e) {
            (w.scrollTop = 0),
                (e.target.contains && e.target.contains(w)) || (T && !1 === T(o, e)) || ($.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, 'center center'), (g = e.target));
        }
        function Xa(t, e) {
            ...
            var r = isNaN(e.ratio) ? 1 : e.ratio,
                ...
                a = e.pins || [],
                s = a.offset || 0,
                l = (e._startClamp && e.start <= 0) || (e.pins && e.pins.offset) ? 0 : e._endClamp && e.end === C() ? 1 : 0.5;
            return (
            ...
            Pa(),
                ...
                S &&
                    ...
                    S.forEach(function (e) {
                        ...
                        e._startClamp && t < 0
                            ? ((n = (r = e.ratio < 0 ? C() : e.end / e.ratio) - e.end), (t = 0))
                            : (e.ratio < 0 || (e._endClamp && r >= C())) && (n = ((r = C()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) * e.ratio - (e.end - e.start)),
                            (e.offset = n || 1e-4),
        ...
        function db(r, e, t, n, o) {
            function oc() {
                (e = u()),
                    ...
                    (s = 'auto' === e.value),
                    (c = s || (a && a._startClamp && a.start <= 0) || p.offset ? 0 : a && a._endClamp && a.end === C() ? 1 : 0.5),
                    l && l.kill(),
            ...
            function sc(e) {
                if (s) {
                    ...
                    var t = (function _autoDistance(e, t) {
                        ...
                        return (
                            0 < c &&
                                ((n = 0.5 == (r = a.height / (I.innerHeight + a.height)) ? 2 * a.height : 2 * Math.min(a.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)),
                                (f += t ? -n * t : -n / 2),
                                (c += n)),
                            { change: c, offset: f }
                        );
                            ...
                            onUpdate: function onUpdate(e) {
                                ...
                                if (e.offset) {
                                    if (i) {
                                        for (r = -H, n = e.end; i--; ) {
                                            if ((t = p[i]).trig.isActive || (r >= t.start && r <= t.end))
                                                return void (
                                                    l &&
                                                    ((t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001), t.trig.update(0, 0, 1), l.resetTo('y', parseFloat(g.y), -N, !0), M && l.progress(1))
                                                );
                                    ...
                                    m.length &&
                                        ...
                                        l ? (l.resetTo('y', o, -N, !0), M && l.progress(1)) : ((g.y = o + 'px'), g.renderTransform(1));
                                }
                            },
                        }))
                    ),
        ...
        var n,
            ...
            P = t.effectsPrefix || '',
            E = $.getScrollFunc(I),
            k = 1 === $.isTouch ? (!0 === p ? 0.8 : parseFloat(p) || 0) : 0 === b || !1 === b ? 0 : parseFloat(b) || 0.8,
            A = (k && +t.speed) || 1,
            H = 0,
            N = 0,
            M = 1,
        ...
        _a(),
            ...
            (this.scrollTo = function (e, t, r) {
                ...
                t ? (f ? F.to(o, { duration: k, scrollTop: n, overwrite: 'auto', ease: Y }) : E(n)) : Ta(n);
            }),
            ...
            (this.content = function (e) {
                if (arguments.length) {
                    var t = D(e || '#smooth-content')[0] || console.warn('ScrollSmoother needs a valid content element.') || q.children[0];
                    return (
                        t !== n &&
        ...
        B.forEach(function (e) {
                ...
                onRefreshInit: function onRefreshInit(e) {
                    if (!ScrollSmoother.isRefreshing) {
                        ...
                        (d = r && r._end > r._dp._time),
                            (u = H),
                            (O.y = 0),
                            k && (1 === $.isTouch && (w.style.position = 'absolute'), (w.scrollTop = 0), 1 === $.isTouch && (w.style.position = 'fixed'));
                    }
                },
            ...
            t.effects && this.effects(!0 === t.effects ? '[data-' + P + 'speed], [data-' + P + 'lag]' : t.effects, { effectsPadding: t.effectsPadding }),
                ...
                return arguments.length
                    ? (!!f !== e &&
                          (e
                              ...
                              : (f.nested.kill(), f.kill(), (f = 0), r && r.enable(), (i.progress = (-H / A - i.start) / (i.end - i.start)), Ra(i))),
                      this)
                    : !!f;
            }),
            ...
            _ && (this.normalizer = $.normalizeScroll(!0 === _ ? { debounce: !0, content: !k && n } : _)),
            $.config(t),
            'overscrollBehavior' in I.getComputedStyle(q) && F.set([q, U], { overscrollBehavior: 'none' }),
            'scrollBehavior' in I.getComputedStyle(q) && F.set([q, U], { scrollBehavior: 'auto' }),
